...
export const NoiseBackground = ({
  ...
  containerClassName,
  gradientColors = [
    "rgb(124, 58, 237)", // OctaClaw Purple
    "rgb(5, 150, 105)",  // OctaClaw Green
    "rgb(255, 200, 100)", // Highlight Gold
  ],
  noiseIntensity = 0.2,
  speed = 0.1,
  backdropBlur = false,
  ...
  return (
    <div
      ...
      className={cn(
        group && "group",
        "relative overflow-hidden rounded-2xl bg-neutral-200 p-2 backdrop-blur-sm dark:bg-neutral-800",
