...
export default function HowItWorksSection() {
  return (
    <section id="howitworks" className="relative py-16 sm:py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-5xl font-semibold tracking-[-0.01em] text-white">How it works</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="mt-3 text-xl text-white font-semibold">{step.title}</h3>
